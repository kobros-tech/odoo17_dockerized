...
RUN apt-get install -y --allow-downgrades ./wkhtmltox_0.12.5-1.focal_amd64.deb
...
RUN curl -L http://github.com/odoo/odoo/archive/17.0.tar.gz | tar zxf -
RUN cp -r odoo-17.0/addons /usr/lib/python3/dist-packages/odoo/addons
